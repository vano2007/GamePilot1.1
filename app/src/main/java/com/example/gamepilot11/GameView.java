...
import com.example.gamepilot11.entity.Asteroid;
import com.example.gamepilot11.entity.Background;
import com.example.gamepilot11.entity.Bullet;
import com.example.gamepilot11.entity.Flight;
    ...
    private void update() {
        ...
        for (Asteroid asteroid : asteroids) {
            ...
            if ((asteroid.getX() + asteroid.getWidth()) < 0) {
                ...
                // если скорость астероида меньше 5
